    ...
    render() {
      ...
      present.forEach((id) => {
        ...
        const card = U.el('article', {
          ...
          U.el('div', { class: 'ecard__code', text: e.code + (LC.hasTag(id,'counter') ? ' · against you' : '') }),
          ...
          U.el('div', { class: 'ecard__foot' }, [
            ...
            U.el('span', { class: 'ecard__code', text: LC.hasTag(id,'hot') ? 'handle with care' : (LC.hasTag(id,'forgeable') && st === 'held' ? 'source unproven' : '') })
          ])
        ]);
